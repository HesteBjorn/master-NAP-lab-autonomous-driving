...
ROUTES_FILE="${WORK_DIR}/leaderboard/data/bench2drive220.xml"
...
BASE_PORT=30000
BASE_TM_PORT=50000
SAVE_DIR_NAME="../outputs/eval_bench2drive220_full"  # put in outputs folder
BASE_CHECKPOINT_NAME="eval_bench2drive220_full"
