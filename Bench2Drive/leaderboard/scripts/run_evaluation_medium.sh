...
ROUTES_FILE="${WORK_DIR}/leaderboard/data/bench2drive22_medium.xml"
...
SAVE_DIR_NAME="../outputs/eval_bench2drive22_medium"  # put in outputs folder
# BASE_CHECKPOINT_NAME="eval_bench2drive3_short"
BASE_CHECKPOINT_NAME="eval_bench2drive22_medium"
